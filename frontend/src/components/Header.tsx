...
function Header() {
    ...
    return (
        <>
            <header className="bg-black w-full h-auto border-0 border-b-[#E0E0E0] border-solid border-b-1">
                <div className="mx-auto max-w-9xl px-2 sm:px-4 lg:px-6">
                    <div className="relative flex h-12 md:h-16 items-center justify-between">
                        <div className="flex flex-row justify-center items-center">
                            ...
                            <Link to="/" className="hidden sm:block text-xl text-white font-semibold font-mono hover:text-[#E0E0E0] transition-colors duration-200">
                        ...
                        <div className="flex-row hidden lg:flex">
                            {routes.map((route) => (
                                <Link className="flex flex-row text-xl text-gray-300 font-mono p-2 hover:text-white transition-colors duration-200" to={route[1]} >
                                    ...
                                    <p className={(location.pathname == route[1]) ? "text-[#E0E0E0]" : ""}>
                                        {route[0]}
                                    </p>
                                </Link>
                            ))}
                        ...
                        <div
                            className={`p-4 fixed top-0 right-0 h-full w-38 bg-black shadow-lg transform transition-transform duration-300 ${open ? "translate-x-0" : "translate-x-full"
                                }`}
